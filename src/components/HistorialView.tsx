...
export const HistorialView: React.FC = () => {
  ...
  }, [transacciones, typeFilter, search, items]);
  ...
  const handleExportCSV = () => {
    ...
    downloadCsv(`Reporte_Historial_${new Date().toISOString().split('T')[0]}.csv`, csvContent);
    showToast('Reporte de historial exportado exitosamente', 'success');
  };
      ...
      <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Bitácora de auditoría de todas las entradas y salidas registradas
          </p>
        </div>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-4 flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex bg-gray-100 p-1 rounded-xl w-full md:w-auto">
          <button
            ...
            className={`flex-1 md:flex-none px-4 py-1.5 text-xs font-semibold rounded-lg transition ${
              typeFilter === 'todos'
          ...
          <button
            ...
            className={`flex-1 md:flex-none px-4 py-1.5 text-xs font-semibold rounded-lg transition flex items-center justify-center gap-1 ${
              typeFilter === 'entrada'
          ...
          >
            ...
            Entradas ({transacciones.filter(t => t.tipo === 'entrada').length})
          </button>
          <button
            type="button"
            onClick={() => {
          ...
          >
            ...
            Salidas ({transacciones.filter(t => t.tipo === 'salida').length})
          </button>
        </div>
